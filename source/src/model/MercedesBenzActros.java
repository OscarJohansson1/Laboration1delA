...
/**
 * The model.MercedesBenzActros class describes a car-transporter of the type Mercedes-Benz Actros.
 */
public class MercedesBenzActros extends Car implements ITransporter<Car>{
    ...
    /**
     * model.Car-trailer connected from the beginning.
     */
    ...
    /**
     * Method from model.IMovable, overridden from model.Car, which updates the position of cars stored on the car-transporter
     * while it's moving.
     */
    @Override
    public void move() {
    ...
    /**
     * Method from model.ITransporter which loads the car trailer with a car if it's close enough to the car trailer.
    ...
    /**
     * Method from model.ITransporter which unloads the latest stored car if the Actros stands still.
