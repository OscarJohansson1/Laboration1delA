 ...
 * Intended, but not limited, to be used in other classes which implements model.ITransporter functions.
 */
public class Storage<T> implements ILoadable<T> {
    ...
    public T removeAtIndex(int i){
        if(storedObjects.size() > 0){
            ...
            System.out.println("Cannot remove object as model.Storage is empty");
        }
        return null;
    }
    /**
