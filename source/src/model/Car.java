...
/**
 * The model.Car class describes shared elements between the different car-models. No object of model.Car should be able to be
...
public abstract class Car implements IMovable, ITransportable, ICar {
    ...
    // Abstract methods that should be implemented in every class extending model.Car
    ...
    /**
     * Implementation of interface model.IMovable method move.
     */
    @Override
    public void move() {
    ...
    /**
     * Implementation of interface model.IMovable method turnLeft.
     */
    @Override
    ...
    /**
     * Implementation of interface model.IMovable method turnRight.
     */
    @Override
